<p align="center">
  <a href="https://lvtd.dev">
    <img src="https://raw.githubusercontent.com/LVTD-LLC/.github/main/profile/assets/lvtd-fire-heart.png" alt="LVTD flaming heart" width="112" height="112">
  </a>
</p>

<h1 align="center">LVTD</h1>

<p align="center"><strong>Useful software. From first idea to running product.</strong></p>

<p align="center">
  <a href="https://lvtd.dev">Website</a> &middot;
  <a href="https://lvtd.dev/blog/">Writing</a> &middot;
  <a href="mailto:rasul@lvtd.dev?subject=Project%20brief">Start a build</a>
</p>

We're a product lab and engineering studio led by [Rasul Kireev](https://github.com/rasulkireev).
We build and operate our own products, and help founders and small teams ship theirs.
...
| --- | --- |
| **[Rowset](https://github.com/LVTD-LLC/rowset)** | A dataset backend for AI agents: store, query, update, and export structured data through MCP, REST, and a CLI. |
...
Have a product to launch or a workflow that should be software? We can help with:

- **MVPs:** a focused first release, from scope and interface to backend and deployment.
...
Found something useful? Start with that project's README for setup and its license
for usage terms. Bugs and ideas belong in the relevant repository's issues;
contribution guidance lives with each project.
